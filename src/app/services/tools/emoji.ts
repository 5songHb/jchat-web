import { imgRouter } from '../../../app/services/common';
...
export let Emoji = {
	...
	trans:  function(text) {
		...
		text = text.replace(Emoji.reg, function(code) {
			return '<img width=' + fontSize + ' class="emoji" style="vertical-align:middle" src="' + imgRouter + Emoji._escapeToUtf32(code) + '.png">';
		});
